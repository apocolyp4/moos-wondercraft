 ...
 *
 */
public class Toast extends SimpleSlimefunItem<ItemConsumptionHandler> {

    @ParametersAreNonnullByDefault
    public Toast(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
