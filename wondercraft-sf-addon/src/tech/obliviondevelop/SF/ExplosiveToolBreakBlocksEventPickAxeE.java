...
public class ExplosiveToolBreakBlocksEventPickAxeE extends PlayerEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();

    private final ItemStack itemInHand;
    private final MoosEnhancedPickaxe explosiveTool;
    private final Block mainBlock;
    private final List<Block> additionalBlocks;
    private boolean cancelled;

    @ParametersAreNonnullByDefault
    public ExplosiveToolBreakBlocksEventPickAxeE(Player player, Block block, List<Block> blocks, ItemStack item, MoosEnhancedPickaxe explosiveTool) {
        super(player);
     ...
     */
    @Nonnull
    public MoosEnhancedPickaxe getExplosiveTool() {
