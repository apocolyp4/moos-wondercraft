...
public class WonderMinerAndroidIII extends ProgrammableAndroid {
	...
	public WonderMinerAndroidIII(Category category) {
        super(category, 
        		1,
				new SlimefunItemStack("WONDER_MINER_ANDROID_III", WonderItems.WONDER_MINER_ANDROID_III), 
				RecipeType.ENHANCED_CRAFTING_TABLE, 
				new ItemStack[] {WonderItems.POWER_CELL, WonderItems.PRINTED_CIRCUIT_BOARD, SlimefunItems.ANDROID_MEMORY_CORE, WonderItems.CHROMIUM_INGOT, WonderItems.WONDER_MINER_ANDROID_II, WonderItems.CHROMIUM_INGOT, WonderItems.WONDER_ALLOY, new ItemStack(Material.DIAMOND_PICKAXE), WonderItems.WONDER_ALLOY}
				);
