...
public class ExplosiveToolBreakBlocksEventMooHoe extends PlayerEvent implements Cancellable {

    private static final HandlerList handlers = new HandlerList();

    private final ItemStack itemInHand;
    private final MoosHoe explosiveTool;
    private final Block mainBlock;
    private final List<Block> additionalBlocks;
    private boolean cancelled;

    @ParametersAreNonnullByDefault
    public ExplosiveToolBreakBlocksEventMooHoe(Player player, Block block, List<Block> blocks, ItemStack item, MoosHoe explosiveTool) {
        super(player);
     ...
     */
    @Nonnull
    public MoosHoe getExplosiveTool() {
